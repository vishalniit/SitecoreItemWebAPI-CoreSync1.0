...
namespace Mindtree.Sitecore.WebApi.Client.Net
{
    /// <summary>
    /// Form Upload Class give the bytes representation
    /// of Form Data
    /// </summary>
    public static class FormUpload
    {
        private static readonly Encoding encoding = Encoding.UTF8;
        private static HttpWebResponse PostForm(Uri postUrl, string userAgent, string contentType, byte[] formData, ResponseFormat responseFormat)
        {
        ...
        public static byte[] GetMultipartFormDataOne(Dictionary<string, object> postParameters, string boundary)
        {
            Stream formDataStream = new System.IO.MemoryStream();
            bool needsCLRF = false;
    ...
    /// <summary>
    /// Object which wraps the Attached File
    /// In HTTP Request
    /// </summary>
